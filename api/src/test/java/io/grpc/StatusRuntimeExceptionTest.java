...
public class StatusRuntimeExceptionTest {
    ...
    public void internalCtorRemovesStack() {
        StackTraceElement[] trace =
                new StatusRuntimeException(Status.CANCELLED, null, false) {
                }.getStackTrace();
    ...
    public void normalCtorKeepsStack() {
        StackTraceElement[] trace =
                new StatusRuntimeException(Status.CANCELLED, null) {
                }.getStackTrace();
    ...
    public void extendPreservesStack() {
        StackTraceElement[] trace = new StatusRuntimeException(Status.CANCELLED) {
        }.getStackTrace();
